...
ALTER SEQUENCE userupdates_id_seq OWNED BY userupdates.id;
...
ALTER SEQUENCE leaverecord_id_seq OWNED BY leaverecord.id;
...
REFERENCES leaverecord (id) MATCH SIMPLE
...
ALTER SEQUENCE leaveupdates_id_seq OWNED BY leaveupdates.id;
...
ALTER SEQUENCE publicholiday_id_seq OWNED BY publicholiday.id;
